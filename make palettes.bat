...
palgen_persune.py --skip-plot -aps 5 -ela 0.01429 -e -o docs/example_palettes/2C02G_aps_ela_NTSC_persune_GVUSB2_NTSC_M_J -phs -5 -hue -12 -sat 0.8
palgen_persune.py --skip-plot -aps 5 -ela 0.01429 -e -o docs/example_palettes/2C02G_aps_ela_NTSC_persune_GVUSB2_NTSC_M -phs -5 -hue -12 -sat 0.8 -gai -6.5 -blp 6
