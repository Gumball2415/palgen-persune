...
palgen_persune.py --skip-plot -aps 5 -ela 0.01429 -e -hue -2.5 -sat 0.9 -o docs/example_palettes/2C02G_aps_ela_NTSC_persune_tink
palgen_persune.py --skip-plot -aps 5 -ela 0.01429 -e -o docs/example_palettes/2C02G_aps_ela_NTSC_persune_GVUSB2_NTSC_M_J -phs -5 -hue -12 -sat 0.8 -gai -5
palgen_persune.py --skip-plot -aps 5 -ela 0.01429 -e -o docs/example_palettes/2C02G_aps_ela_NTSC_persune_GVUSB2_NTSC_M -phs -5 -hue -12 -sat 0.8 -gai -11.5 -blp 6
palgen_persune.py --skip-plot -ela 0.01429 -ppu "2C07" -blp 7.5 -e -o docs/example_palettes/2C07_ela_PAL
...
palgen_persune.py --skip-plot -ppu "2C05-99" -sat 0.8 -e -o docs/example_palettes/2C05-99_composite_forple